...
const data = [
  { id: 1, actMess: true, date: '23.02.2030', time: '10.23.45', date2: '', time2: '', name: 'Oli Bob', age: '12', col: 'red', dob: '', rating: 4.5, passed: true },
  { id: 2, actMess: true, date: '23.02.2040', time: '10.23.45', date2: '23.02.2019', time2: '', name: 'Mary May', age: '1', col: 'blue', dob: '14/05/1982', rating: 2.5, passed: true },
  { id: 3, actMess: true, date: '23.02.2019', time: '10.23.45', date2: '23.02.2019', time2: '', name: 'Christine Lobowski', age: '42', col: 'green', dob: '22/05/1982' },
  { id: 4, actMess: true, name: 'Brendon Philips', age: '125', date2: '23.02.2019', time2: '', col: 'orange', dob: '01/08/1980' },
  { id: 5, actMess: true, date: '23.02.2019', time: '10.23.45', date2: '23.02.2019', time2: '', name: 'Авария 1', kvit: false, active: false },
  { id: 6, actMess: true, date: '23.02.2019', time: '10.23.45', date2: '23.02.2019', time2: '', name: 'Авария 1', kvit: false, active: false },
  { id: 7, actMess: true, date: '23.02.2019', time: '10.23.45', date2: '23.02.2019', time2: '', name: 'Авария 1', kvit: false, active: false },
  { id: 8, actMess: true, date: '23.02.2019', time: '10.23.45', date2: '23.02.2019', time2: '', name: 'Авария 1', kvit: false, active: false },
  { id: 9, actMess: true, date: '23.02.2019', time: '10.23.45', date2: '23.02.2019', time2: '', name: 'Авария 1', kvit: false, active: false },
  { id: 10, actMess: true, date: '23.02.2019', time: '10.23.45', date2: '23.02.2019', time2: '', name: 'Авария 1', kvit: false, active: false },
  ...
  if (message.name === 'alarm_0') { // обработка байтов
    ...
    if (ok) {
      b.forEach((bit, i) => {
        ...
        const val = store.find(item => item.id === i + 1); // ищем объект по ID
