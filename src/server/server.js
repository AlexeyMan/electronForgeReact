...
const client = [];
const configCon = con.configCon;
const DevPac = Dev.dev;
let btnStop = false;
// client[0] = new ModbusRTU();
// const file = `${__dirname}/config.json`; // './src/config.json';
// const fileDev = `${__dirname}/configDev.json`;
// const cCon = fs.readFileSync(file, 'utf8', (err, data) => {
...
// const DPac = fs.readFileSync(fileDev, 'utf8', (err, data) => {
//   if (err) return console.log(err);
...
// JSON.parse('data');
// const DevPac = JSON.parse(conf);
// const configCon = JSON.parse(cCon);
const sleep = ms => new Promise(resolve => setTimeout(resolve, ms));
// запрашиваем конфигурацию портов
// const configCon = jsonfile.readFileSync(file);

// console.log(configCon.Device, DevPac);
